...
with st.sidebar:
    ...
    st.divider()
    st.caption("**Infosys Business Incubator Cohort 2**")
...
<div class="app-header">
  ...
  <div>
    ...
    <div style="color:#94A3B8;font-size:.95rem">Real-time hallucination detection powered by Claude · Infosys Business Incubator Cohort 2</div>
  </div>
</div>
""", unsafe_allow_html=True)
